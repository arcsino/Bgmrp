...
class HelpView(ft.Column):
    def __init__(self):
        ...
        self.controls = [
            ...
            BorderImage(src=Path("images/help1.png")),
            ft.Divider(color=ft.Colors.TRANSPARENT),  # margin
            # No.2
            SmallExplainContainer(
                title="2. BGMを用意する",
            ...
            BorderImage(src=Path("images/help2.png")),
            ft.Divider(color=ft.Colors.TRANSPARENT),  # margin
            # No.3
            SmallExplainContainer(
                title="3. プロジェクトを作成する",
            ...
            BorderImage(src=Path("images/help3.png")),
            ft.Divider(color=ft.Colors.TRANSPARENT),  # margin
            # No.4
            SmallExplainContainer(
                title="4. プロジェクトを編集する",
            ...
            BorderImage(src=Path("images/help4.png")),
            ft.Divider(color=ft.Colors.TRANSPARENT),  # margin
            # No.5
            SmallExplainContainer(
            ...
            BorderImage(src=Path("images/help5.png")),
            ft.Divider(color=ft.Colors.TRANSPARENT),  # margin
            # No.6
            SmallExplainContainer(
            ...
            BorderImage(src=Path("images/help6.png")),
            ft.Divider(color=ft.Colors.TRANSPARENT),  # margin
            # No.7
            SmallExplainContainer(
            ...
            BorderImage(src=Path("images/help7.png")),
            ft.Divider(color=ft.Colors.TRANSPARENT),  # margin
            # No.8
            SmallExplainContainer(
                title="8. BGMを選択する",
            ...
            BorderImage(src=Path("images/help8.png")),
            ft.Divider(color=ft.Colors.TRANSPARENT),  # margin
            # No.9
            SmallExplainContainer(
                title="9. BGMの音量を設定する",
            ...
            BorderImage(src=Path("images/help9.png")),
            ft.Divider(color=ft.Colors.TRANSPARENT),  # margin
            # No.10
            SmallExplainContainer(
                title="10. バージョンを設定する",
            ...
            BorderImage(src=Path("images/help10.png")),
            ft.Divider(color=ft.Colors.TRANSPARENT),  # margin
            # No.11
            SmallExplainContainer(
                title="11. 保存する",
            ...
            BorderImage(src=Path("images/help11.png")),
            ft.Divider(color=ft.Colors.TRANSPARENT),  # margin
            # No.12
            SmallExplainContainer(
                title="12. 作成する",
            ...
            BorderImage(src=Path("images/help12.png")),
            ft.Divider(color=ft.Colors.TRANSPARENT),  # margin
            # No.13
            SmallExplainContainer(
                title="13. エラーについて",
            ...
            BorderImage(src=Path("images/help13.png")),
            ft.Divider(color=ft.Colors.TRANSPARENT),  # margin
        ]
